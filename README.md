# myStudiesPlan_CAS-Server

**myStuidesPlan web app uses Central Authorization Service (CAS) to implement Single Sign On (SSO). The project below is an implementation of a CAS server, configured to work with [myStudiesPlan_Backend](https://github.com/Charalampidis87/myStudiesPlan_Backend) service.**
...
- [JDK](https://www.oracle.com/java/technologies/downloads/) (`JDK 1.8` or later)
- [Apache Maven](https://maven.apache.org/download.cgi)
- [MySQL](https://www.mysql.com/downloads/) (Database to store and retrieve users and user details)
